...
public class Main<Length1> {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String filepath = "src/orig.txt";
        File file = new File(filepath);
        File file2 = new File("src/orig_add.txt");
        File file3 = new File("src/Repeat_rate.txt");
      ...
      //  System.out.println(Str_2.toString());
        ...
        try (FileWriter writer = new FileWriter("src/Repeat_rate.txt")) {
            writer.write(ans);
            writer.close();
        } catch (Exception e) {
            e.printStackTrace();
